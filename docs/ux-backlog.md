...
### S1 · Shared `<Drawer>` primitive — **P1 · L** — 🟡 IN PROGRESS (claude/ux-backlog-batch-8, 2026-07-14; primitive built + trash-drawer migrated, 4 drawers to follow)
