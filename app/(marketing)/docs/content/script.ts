...
export const script: DocSection = {
  ...
  overview: [
    ...
    },
    {
      ...
      body: `<p>Anyone with access to the production can read the script and make their own annotations, cues, and bookmarks. Managing the script itself takes a role with document upload rights: admins, producers, directors, choreographers, creatives, and stage managers can upload scripts, choose the default script, run and apply the AI analysis, make a scanned script searchable, and drag cue labels into custom positions. Cast and crew read and mark up their own copy only. See <a href="/docs/people/roles-and-permissions">roles and permissions</a> for the full breakdown.</p>`,
    },
  ],
  pages: [
    {
      ...
      nextSteps: [
        { label: "Run the AI script analysis", href: "/docs/script/ai-script-analysis" },
        { label: "Start marking up your copy", href: "/docs/script/annotations-and-highlights" },
        { label: "The production setup wizard", href: "/docs/productions/setup-wizard" },
      ],
      related: [
        { label: "Placing cue markers", href: "/docs/script/cue-markers" },
        { label: "Script upload issues", href: "/docs/troubleshooting/script-upload-issues" },
        { label: "Roles and permissions", href: "/docs/people/roles-and-permissions" },
        { label: "Setting up your ground plan", href: "/docs/blocking/setting-up-your-ground-plan" },
      ],
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          body: `<p>From the applied screen, click <strong>Assign actors</strong> to open the Cast &amp; Crew page, where each parsed character can be cast with a real person. See the <a href="/docs/productions/cast-crew-board">cast and crew board</a> for how casting works.</p>`,
        },
        {
      ...
      nextSteps: [
        { label: "Mark up your script", href: "/docs/script/annotations-and-highlights" },
        { label: "Capture blocking against the scene list", href: "/docs/blocking/capturing-blocking-beats" },
        { label: "The cast and crew board", href: "/docs/productions/cast-crew-board" },
      ],
      related: [
        { label: "Uploading a script", href: "/docs/script/uploading-a-script" },
        { label: "Cue markers and cue sheets", href: "/docs/script/cue-markers" },
        { label: "Roles and permissions", href: "/docs/people/roles-and-permissions" },
        { label: "Script upload issues", href: "/docs/troubleshooting/script-upload-issues" },
      ],
    },
    {
      ...
      nextSteps: [
        { label: "Place cue markers", href: "/docs/script/cue-markers" },
        { label: "Run the AI script analysis", href: "/docs/script/ai-script-analysis" },
        { label: "Your first rehearsal", href: "/docs/get-started/your-first-rehearsal" },
      ],
      related: [
        { label: "Uploading a script", href: "/docs/script/uploading-a-script" },
        { label: "Script upload issues", href: "/docs/troubleshooting/script-upload-issues" },
        { label: "Capturing blocking beats", href: "/docs/blocking/capturing-blocking-beats" },
        { label: "Creating a rehearsal report", href: "/docs/reports/creating-a-rehearsal-report" },
      ],
    },
    {
      slug: "cue-markers",
      ...
      nextSteps: [
        { label: "Annotations and highlights", href: "/docs/script/annotations-and-highlights" },
        { label: "Capturing blocking beats", href: "/docs/blocking/capturing-blocking-beats" },
        { label: "Department notes in reports", href: "/docs/reports/department-notes" },
      ],
      related: [
        { label: "Uploading a script", href: "/docs/script/uploading-a-script" },
        { label: "AI script analysis", href: "/docs/script/ai-script-analysis" },
        { label: "Roles and permissions", href: "/docs/people/roles-and-permissions" },
        { label: "Script upload issues", href: "/docs/troubleshooting/script-upload-issues" },
      ],
    },
