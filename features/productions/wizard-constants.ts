...
export const TEAM_ROLES: WizardTeamRole[] = [
  ...
  { label: "Music Director", dept: "music", c: "plum", appRole: "creative" },
  { label: "Conductor", dept: "music", c: "plum", appRole: "creative" },
  { label: "Choreographer", dept: "choreo", c: "plum", appRole: "choreographer" },
  { label: "Costume Designer", dept: "costumes", c: "clay", appRole: "creative" },
  { label: "Lighting Designer", dept: "lighting", c: "amber", appRole: "creative" },
  { label: "Sound Designer", dept: "sound", c: "dusk", appRole: "creative" },
  { label: "Set Designer", dept: "set", c: "sage", appRole: "creative" },
  { label: "Props Master", dept: "props", c: "sand", appRole: "creative" },
